...
class gsp_mesaAyuda_role_form_gsp extends GroovyPage {
...
printHtmlPart(3)
expressionOut.print(hasErrors(bean: roleInstance, field: 'descripcion', 'error'))
printHtmlPart(4)
invokeTag('message','g',16,['code':("role.descripcion.label"),'default':("Descripcion")],-1)
printHtmlPart(2)
invokeTag('textField','g',19,['name':("descripcion"),'required':(""),'value':(roleInstance?.descripcion)],-1)
printHtmlPart(5)
}
