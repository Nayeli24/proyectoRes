...
class gsp_mesaAyuda_rolecreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(roleInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(roleInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',35,['url':([resource:roleInstance, action:'save'])],2)
printHtmlPart(22)
})
