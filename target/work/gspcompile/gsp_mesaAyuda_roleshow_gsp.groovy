...
class gsp_mesaAyuda_roleshow_gsp extends GroovyPage {
...
printHtmlPart(14)
invokeTag('message','g',28,['code':("role.authority.label"),'default':("Authority")],-1)
printHtmlPart(15)
invokeTag('fieldValue','g',30,['bean':(roleInstance),'field':("authority")],-1)
printHtmlPart(16)
}
printHtmlPart(17)
if(true && (roleInstance?.descripcion)) {
printHtmlPart(18)
invokeTag('message','g',37,['code':("role.descripcion.label"),'default':("Descripcion")],-1)
printHtmlPart(19)
invokeTag('fieldValue','g',39,['bean':(roleInstance),'field':("descripcion")],-1)
printHtmlPart(16)
}
printHtmlPart(20)
createTagBody(2, {->
...
invokeTag('link','g',47,['class':("edit"),'action':("edit"),'resource':(roleInstance)],3)
printHtmlPart(22)
...
invokeTag('form','g',50,['url':([resource:roleInstance, action:'delete']),'method':("DELETE")],2)
printHtmlPart(24)
})
