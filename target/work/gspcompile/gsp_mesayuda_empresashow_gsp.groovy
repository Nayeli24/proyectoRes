...
class gsp_mesayuda_empresashow_gsp extends GroovyPage {
...
printHtmlPart(8)
invokeTag('fieldValue','g',37,['bean':(empresaInstance),'field':("nombreEmpresa")],-1)
printHtmlPart(9)
invokeTag('formatBoolean','g',37,['boolean':(empresaInstance?.enabled),'true':("Activa"),'false':("Inactiva")],-1)
printHtmlPart(10)
}
printHtmlPart(11)
}
...
public static final long LAST_MODIFIED = 1525892194000L
