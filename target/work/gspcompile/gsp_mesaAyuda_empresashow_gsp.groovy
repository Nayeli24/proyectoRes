...
class gsp_mesaAyuda_empresashow_gsp extends GroovyPage {
...
printHtmlPart(2)
invokeTag('javascript','g',12,['library':("prototype")],-1)
printHtmlPart(5)
})
invokeTag('captureHead','sitemesh',13,[:],1)
printHtmlPart(6)
if(true && (empresaInstance?.nombreEmpresa)) {
printHtmlPart(7)
invokeTag('fieldValue','g',45,['bean':(empresaInstance),'field':("nombreEmpresa")],-1)
printHtmlPart(8)
invokeTag('formatBoolean','g',45,['boolean':(empresaInstance?.enabled),'true':("Activa"),'false':("Inactiva")],-1)
printHtmlPart(9)
}
printHtmlPart(10)
}
