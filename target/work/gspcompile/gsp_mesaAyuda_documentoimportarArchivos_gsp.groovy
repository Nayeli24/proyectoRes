...
class gsp_mesaAyuda_documentoimportarArchivos_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/documento/importarArchivos.gsp" }
public Object run() {
Writer out = getOut()
