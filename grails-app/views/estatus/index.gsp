		...
		<div id="list-estatus" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="tipo_estatus" title="${message(code: 'estatus.tipo_estatus.label', default: 'Tipoestatus')}" />
				...
				<g:each in="${estatusInstanceList}" status="i" var="estatusInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${estatusInstance.id}">${fieldValue(bean: estatusInstance, field: "tipoEstatus")}</g:link></td>
			...
			<div class="pagination">
				<g:paginate total="${estatusInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
